...
# os.environ['PROVER9'] = "Evo-Logic-LM/Prover9/bin"
current_dir = os.path.dirname(os.path.abspath(__file__))
parent_dir = os.path.dirname(current_dir)
prover9_path = os.path.join(parent_dir, 'Prover9', 'bin')
os.environ['PROVER9'] = prover9_path
print(f"Prover9 path set to: {os.environ['PROVER9']}")
...
class FOL_Prover9_Program:
    ...
    def execute_program(self):
        try:
            ...
            self.syntax_error = "Error executing Prover9: " + str(e)
            return None, str(e)
